import './../../css/cssSubcomponents/Dowload.css'

const DownloadApp = () => {

  return (
    <>
      <div className="card-donwload">
        <span className="small-text">Download Agora!</span>
        <span className="title">Download do aplicativo</span>
        <span className="desc">Download gratuito para IOS & Android</span>
